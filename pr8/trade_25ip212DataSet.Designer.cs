...
namespace pr8 {
    ...
    public partial class trade_25ip212DataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string FIO, string Position, string Password) {
...
namespace pr8.trade_25ip212DataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employee] WHERE (([id] = @Original_id) AND ([FIO] = @Original_" +
                "FIO) AND ([Position] = @Original_Position) AND ([Password] = @Original_Password)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([FIO], [Position], [Password]) VALUES (@FIO, @Posit" +
                "ion, @Password);\r\nSELECT id, FIO, Position, Password FROM Employee WHERE (id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [FIO] = @FIO, [Position] = @Position, [Password] = @Password WHERE (([id] = @Original_id) AND ([FIO] = @Original_FIO) AND ([Position] = @Original_Position) AND ([Password] = @Original_Password));
SELECT id, FIO, Position, Password FROM Employee WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::pr8.Properties.Settings.Default.trade_25ip212ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, FIO, Position, Password FROM dbo.Employee";
        ...
        public virtual int Fill(trade_25ip212DataSet.EmployeeDataTable dataTable) {
        ...
        public virtual trade_25ip212DataSet.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            trade_25ip212DataSet.EmployeeDataTable dataTable = new trade_25ip212DataSet.EmployeeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(trade_25ip212DataSet.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_FIO, string Original_Position, string Original_Password) {
        ...
        public virtual int Insert(string FIO, string Position, string Password) {
            if ((FIO == null)) {
        ...
        public virtual int Update(string FIO, string Position, string Password, int Original_id, string Original_FIO, string Original_Position, string Original_Password, int id) {
            if ((FIO == null)) {
                throw new global::System.ArgumentNullException("FIO");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIO, string Position, string Password, int Original_id, string Original_FIO, string Original_Position, string Original_Password) {
            return this.Update(FIO, Position, Password, Original_id, Original_FIO, Original_Position, Original_Password, Original_id);
        }
    }
